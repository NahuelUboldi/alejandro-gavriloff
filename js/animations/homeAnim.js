...
const initHomePageAnim = function initializeTheHomePageGsapAnimations() {
  ...
  tlBio
    .add(createAppearTween('#bio .display-3'))
  ...
  tlCanvas
    .add(createAppearTween('#canvas .canvas-shadow'))
    .add(createAppearTween('#canvas p'))
    .add(createAppearTween('#canvas button'));

  const tlContact = gsap.timeline();
  tlContact
    .add(createAppearTween('#contact-form .display-4'))
    .add(createAppearTween('#contact-form form'));

  tlMain.add(tlBio).add(tlCanvas).add(tlContact);
